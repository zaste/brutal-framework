...
export class Button extends InteractiveComponent {
 ...
 classes.push('brutal-button--icon-only'
};
    ...
    _createRipple(e) {
        ...
        // Remove ripple after animation, setTimeout(() => this._cleanupRipple(ripple.id), 600);
    }
    ...
    _setupAccessibility() {
        ...
        // Set role if needed, if(this.getAttribute('href' {
