...
export class DataGrid extends DataComponent {
    ...
    static get observedAttributes() {
        return [...super.observedAttributes, 'columns', 'row-height', 'selectable', 
     ...
     */
    _initWebGLRenderer() {
        // Only use WebGL for very large datasets
        if (this._data.length < 50000) return;
    ...
    render() {
        ...
        if (!this._gridConfig.columns.length) {
        ...
        // Use WebGL for massive datasets
    ...
    _renderCell(rowData, column, rowIndex) {
        ...
        // Check cache
        if (!isEditing && this._cellCache.has(cellKey)) {
