...
import { TestRunner, assert, assertEquals, assertLessThan, assertGreaterThan, benchmark } from '../test-suite.js';
...
runner.test('All Performance Gems should work together', async () => {
  ...
  assert(shadow.adoptedStyleSheets?.length > 0 || shadow.querySelector('style'), 'Styles applied');
