...
export class ShaderLibrary {
    ...
    _registerParticleShaders() {
        ...
        this.shaders.set('particle-vertex', {
            type: 'vertex',
        ...
        this.shaders.set('particle-fragment', {
            type: 'fragment',
            source: `#version 300 es
        ...
        this.shaders.set('particle-fire', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
    ...
    _registerEffectShaders() {
        // Glow/blur shader
        this.shaders.set('glow-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
        ...
        this.shaders.set('chromatic-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
    ...
    _registerDebugShaders() {
        // Heatmap shader
        this.shaders.set('heatmap-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
        ...
        // Grid overlay shader
        this.shaders.set('grid-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
        ...
        this.shaders.set('perf-overlay-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
    ...
    _registerDataVizShaders() {
        ...
        this.shaders.set('flow-field-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
        ...
        // Matrix rain effect
        this.shaders.set('matrix-rain-fragment', {
            type: 'fragment',
            source: `#version 300 es
                precision highp float;
        ...
        this.shaders.set('graph-connection-vertex', {
            type: 'vertex',
            source: `#version 300 es
                in vec3 a_position;
                in vec3 a_targetPos;
