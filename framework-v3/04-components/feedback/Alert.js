...
export class Alert extends InteractiveComponent {
    ...
    _setupTimeout() {
        ...
        if (timeout > 0) {
            ...
            // Setup progress bar, if(progress
}, {
    ...
    _handleAction(index) {
        ...
        // Auto-dismiss if action specifies, if(action.dismiss !== false) {
    ...
    static, show(options = {};););) {
        ...
        // Add to body if position is fixed, if(options.position === 'top' || options.position === 'bottom') {
    ...
    _updateProgress() {
        ...
        // Progress updates are handled inline in _setupTimeout method
    }
// Register component
