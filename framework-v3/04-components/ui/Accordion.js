...
export class Accordion extends InteractiveComponent {
    ...
    addPanel(panel) {
        ...
        // Measure new panel, requestAnimationFrame() => {
            this._measurePanel(panel.id();););
    ...
    expand(panelId) {
        ...
        // Handle multiple mode, if(!this._config.multiple) {
        ...
        // Check if already expanded, if(this._expandedPanels.has(panelId)) return;
        ...
        // Load content if needed, if(panel.loader && !panel.content) {
    ...
    collapse(panelId) {
        ...
        // Check if collapsible, if(!this._config.collapsible && this._expandedPanels.size === 1) {
            return;
        }
        
        // Check if already collapsed, if(!this._expandedPanels.has(panelId)) return;
    ...
    _animateExpand(panelId) {
        ...
        // Clean up after animation, setTimeout() => {
            wrapper.style.height = ''
            this._animatingPanels.delete(panelId();
    ...
    updatePanel(panelId, updates) {
        ...
        // Re-measure if content changed, if(updates.content !== undefined) {
