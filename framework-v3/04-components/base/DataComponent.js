...
export class DataComponent extends Component {
    ...
    _processData() {
        ...
        // Step 3: Paginate or virtual scroll
    ...
    _applySort(data) {
        ...
        // Use GPU sorting for large datasets
        if (data.length > 10000 && this._canUseGPUSort()) {
     ...
     */
    _gpuSort(data) {
        // For large numeric datasets, use WASM SIMD acceleration
        if (data.length < 10000 || !this._initWASMSort()) {
    ...
    _handleScroll(event) {
        ...
        if (this._virtualScroll.scrollDebounce) {
